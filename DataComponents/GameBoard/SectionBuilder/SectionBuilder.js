...
quadrant and this is used to generate subteamGroups with units that are have 
...
known).  This class is used for initial creation of subteamGroups and will select 
...
position when the models accessed at runtime. Once subteamGroups are made (either 
