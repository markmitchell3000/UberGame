/*enum TEAM_STRUCTURE{SINGLE_LANE, TRIPLE_LANE, DOUBLING, TRIPLING, QUADRUPLING, CIVILIAN_TS, ZOMBIE_TS};*/
/*team structures: (all teams have a one in twenty chance of having a second titan, this is tracked with a flag.)
Single Lane is one base, one bonus, four towers(two and two), one titan, two guardians, two hunters, five lts, ten soldiers (ten more are generated by base every 90 seconds).
Triple Lane is one base, three bonuses, six towers, one titan, three guardians, three hunters, ten lts, thirty soldiers (thirty more are generated by base every 90 seconds).
Doubling has one titan, two guardians, two hunters, four lts, eight soldiers.
Tripling has one titan, three guardians, three hunters, nine lts, twenty-seven soldiers
Quadrupling has one titan, four guardians, four hunters, sixteen lts, and sixty-four soldiers.
Civilian and zombie structures make the team consist of a set of civilians or zombies, numbering 25 total.  
*/
