...
public class GBUnitTypeCounter{
    ...
    public var guardianCnt:int=0;
    public var hunterCnt:int=0;
    public var ltCnt:int=0;
    public var soldierCnt:int=0;
    public var civOrZomCnt:int=0;
    public var workerCnt:int=0;
}